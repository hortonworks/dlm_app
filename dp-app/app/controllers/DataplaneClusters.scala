...
import com.hortonworks.dataplane.commons.domain.Entities.{DataplaneCluster, HJwtToken, TempDataplaneCluster}
...
class DataplaneClusters @Inject()(
        ...
        dpClusterService
          ...
          .map {
            ...
            case Right(dpCluster) =>
              syncCluster(TempDataplaneCluster(dataplaneCluster.id))
  ...
  private def syncCluster(dataplaneCluster: TempDataplaneCluster)(implicit hJwtToken: Option[HJwtToken]): Future[Boolean] = {
