...
/usr/dp-cluster-service/bin/cluster-service -Ddp.services.db.service.uri=http://dp-db-service:9000 \
    -Dconsul.host=${CONSUL_HOST} -Ddp.services.hdp.proxy.consul.host=${CONSUL_HOST} \
