...
import com.hortonworks.dataplane.http.routes.RangerRoute
...
class RangerRouteSpec extends AsyncFlatSpec with AsyncMockFactory {
  ...
  it should "construct a valid Url when single node config is false" in {
