...
object ResponseEntities {
  ...
  case class BeaconAdminStatusResponse(status: String, version: String, plugins: String, security: String,
                                       wireEncryption: Boolean, rangerCreateDenyPolicy: String, enableSourceSnapshottable: Option[Boolean],
  ...
  case class BeaconHdfsFileResponse(status: String, message: String, totalResults: Long, fileList: Seq[HdfsFile])
