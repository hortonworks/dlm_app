...
-->
# Data Lifecycle Manager (DLM) App
...
This repository is used for the DLM application that plugs-into DPS. Refer to [DPS Platform](https://github.com/hortonworks/dps_platform) for
