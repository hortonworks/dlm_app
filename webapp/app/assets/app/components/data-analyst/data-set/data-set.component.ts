...
export class DataSetComponent implements OnInit {
    ...
    autoGeneratedCategory = [{'name': 'File Size', 'count': 3},
                            {'name': 'File Type', 'count': 5},
                            {'name': 'Frequent Modifications', 'count': 3},
                            {'name': 'Altered Permissions', 'count': 3},
                            {'name': 'Frequent Usage', 'count': 2},
                            ];
    ...
    constructor(private dataSetService: DataSetService, private router: Router, private dataCenterService: DataCenterService,
        ...
        this.dataSetsMap = {'All': [],
            'File Size' : DataSetChartData.getUnclassifiedDataSet('File Size' , ['Medium', 'Large', 'Ultralarge']),
            'File Type': DataSetChartData.getUnclassifiedDataSet('File Type', [ 'PDF', 'Txt', 'Audio', 'Video', 'S3']),
            'Frequent Modifications': DataSetChartData.getUnclassifiedDataSet('Frequent Modifications', [ 'Append', 'Delete', 'Added']),
            'Altered Permissions': DataSetChartData.getUnclassifiedDataSet('Altered Permissions', [ 'Read/Write', 'Read', 'Removed']),
            'Frequent Usage': DataSetChartData.getUnclassifiedDataSet('Frequent Usage', [ 'Usage Count', 'File Type'])
        };
    }
