...
import { storeStub, userServiceStub } from 'testing/mock-services';
...
describe('PairingsComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [
        PairingsComponent,
        MockComponent({ selector: 'dlm-pairing-card' }),
        MockComponent({ selector: 'dlm-pairing-card-list', inputs: ['pairings'] }),
