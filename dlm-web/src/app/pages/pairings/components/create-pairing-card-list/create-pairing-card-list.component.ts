...
export class CreatePairingCardListComponent implements OnInit, OnChanges, ControlValueAccessor {
  ...
  incompatibleClusters: ClusterPairing[];
  ...
  ngOnChanges(changes: {[propertyName: string]: SimpleChange}) {
    if (changes['clusters']) {
      ...
      this.incompatibleClusters = this.clusters.filter(cluster => cluster.beaconIncompatible);
      ...
      cluster.beaconUnhealthy !== true && !cluster.beaconIncompatible && !cluster.lacksPrivilege);
    }
