...
import { storeStub, clusterStub, asyncActionsStub, dlmPropertiesStub } from 'testing/mock-services';
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [
        ...
        MockComponent({ selector: 'dlm-add-entity-button', inputs: ['canAddPolicy', 'canAddPairing'] }),
