      ...
      switchMap(([source, destination, general]) => {
        ...
        if (sourceType && destinationType) {
          ...
          const isHiveCloud = policyType === POLICY_TYPES.HIVE &&  contains([UnderlyingFsForHive.S3,
            UnderlyingFsForHive.WASB], getUnderlyingHiveFS(destinationCluster));
          ...
          if (sourceType === SOURCE_TYPES.CLUSTER && contains([SOURCE_TYPES.S3, SOURCE_TYPES.WASB], destinationType) || isHiveCloud) {
