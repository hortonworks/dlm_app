...
import { activateDisabled, canEdit, suspendDisabled } from 'utils/policy-util';
...
export class JobsOverviewTableComponent extends JobsTableComponent implements OnInit {
  ...
  constructor(protected t: TranslateService,
    ...
    super(store, logService, t, userService);
  }
  ...
  ngOnInit() {
    ...
    this.rowActions = <ActionItemType[]>[
      ...
      {
        label: actionLabel('rerun_job'),
        name: 'RERUN_JOB',
        hiddenFn: this.isRerunDisabled.bind(this),
        disableFn: function () {
      ...
      {
        label: actionLabel('delete_policy'),
        name: 'DELETE_POLICY',
        disableFn: function () {
          return this.userService.isUserReadOnly;
        }.bind(this),
      ...
      {
        label: actionLabel('suspend_policy'),
        name: 'SUSPEND_POLICY',
        disableFn: function () {
          return this.userService.isUserReadOnly;
        }.bind(this),
      ...
      {
        label: actionLabel('activate_policy'),
