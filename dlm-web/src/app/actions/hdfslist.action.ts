...
export const ActionTypes = {
  ...
  FILTER_FILES: requestType('FILTER_FILES')
};
...
export const filterFiles = (clusterId, path, meta = {}): ActionWithPayload<any> => ({
  type: ActionTypes.FILTER_FILES.START, payload: { clusterId, path, meta: {clusterId, path, ...meta} }
});
...
export const filterFilesSuccess = (listStatuses, meta = {}): ActionSuccess => {
  return {type: ActionTypes.FILTER_FILES.SUCCESS, payload: {response: listStatuses, meta}};
};
