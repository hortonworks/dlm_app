...
import {
  AddCloudStoreRequestBodyForADLS, AddCloudStoreRequestBodyForS3, AddCloudStoreRequestBodyForWASB,
...
export const loadAccountsSuccess = (accounts, meta = {}): ActionSuccess => ({
  type: ActionTypes.LOAD_ACCOUNTS.SUCCESS,
  payload: {
    response: accounts,
    meta
  }
...
type CloudStoreRequestBody = AddCloudStoreRequestBodyForS3|AddCloudStoreRequestBodyForADLS|AddCloudStoreRequestBodyForWASB;

export const addCloudStore = (cloud_store: CloudStoreRequestBody, meta = {}):
...
export const validateCredentials = (credentials: ValidateCredentialsRequestBodyForS3, meta = {}): ActionWithPayload<any> => ({
...
export const updateCloudStore = (cloudStore: CloudStoreRequestBody, meta = {}):
    ActionWithPayload<any> => ({
