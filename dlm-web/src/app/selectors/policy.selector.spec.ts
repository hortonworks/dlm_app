...
describe('Policy Selectors', () => {
  ...
  let state: State;
  beforeEach(() => {
    policy1 = <Policy>{id: 'p1', targetCluster: 'dc1$c1', sourceCluster: 'dc2$c2', frequency: 1};
    policy2 = <Policy>{id: 'p2', targetCluster: 'dc2$c2', sourceCluster: 'dc1$c1', frequency: 1};
    policy3 = <Policy>{
      id: 'p3',
      targetCluster: 'not-existing-cluster-1',
      sourceCluster: 'not-existing-cluster-2',
      frequency: 1
    };
    ...
    job1 = <Job>{id: '1', name: 'p1', startTime: '2016-06-12T03:32:00.0Z', policyId: 'p1', duration: 12};
    job2 = <Job>{id: '2', name: 'p2', startTime: '2017-06-12T03:32:00.0Z', policyId: 'p2', duration: 20};
    const policiesState = {
      policies: {
        entities: {
          [policy1.id]: policy1,
