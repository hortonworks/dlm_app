...
export const getStaleClusters = (state: State) => state.staleClusters;
export const getSkuServices = (state: State) => state.skuServices;
export const getGas = (state: State) => state.ga;
export const getDlmProperties = (state: State) => state.dlmProperties;
