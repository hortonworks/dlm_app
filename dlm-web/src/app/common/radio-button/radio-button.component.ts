...
@Component({
  ...
  template: `
    <div *ngIf="type === 'radio'" class="dlm-radio-group">
      <div *ngFor="let radio of items; trackBy: trackByFn" class="dlm-radio-item">
    ...
    <div *ngIf="type === 'buttons'" class="btn-group dlm-radio-group" data-toggle="buttons">
      <label *ngFor="let radio of items; trackBy: trackByFn" (click)="selectValue(radio)"
    ...
    <div *ngIf="type === 'service_icons'" class="dlm-radio-group service-icons">
      <div class="service-icon" *ngFor="let radio of items; trackBy: trackByFn" (click)="selectValue(radio)">
...
export class RadioButtonComponent implements OnInit, ControlValueAccessor {
  ...
  trackByFn(item: RadioItem): string {
    return '' + item.value;
  }
}
