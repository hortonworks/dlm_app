...
export const cloudAccountAdapters = {
  ...
  GCS: createEntityAdapter<GcsAccount>(),
...
export const initialState: State = {
  ...
  GCS: { ...cloudAccountAdapters.GCS.getInitialState({ entities: {} }) },
  ...
  switch (action.type) {
    case fromCloudAccount.ActionTypes.LOAD_ACCOUNTS.SUCCESS: {
      ...
      return {
        ...
        GCS: { ...cloudAccountAdapters.GCS.upsertMany(accountsMap.GCS || [], state.GCS) },
