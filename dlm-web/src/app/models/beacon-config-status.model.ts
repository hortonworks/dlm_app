...
export interface BeaconConfigStatusDetailsConfigs {
  [name: string]: string;
  'hive.metastore.warehouse.dir'?: string;
  'hive.cloud.encryptionAlgorithm'?: string;
  'hive.cloud.encryptionKey'?: string;
...
export interface BeaconSuperUserStatus {
  userName: string;
  hdfsSuperUser: boolean;
}
