...
object ADLSEntities {
  ...
  case class ADLSAccountDetails(provider: String, credentialType: Option[CloudCredentialType],
                                accountName: Option[String]) extends Serializable with CloudAccountDetails

  @SerialVersionUID(142)
  case class ADLSAccountCredentials(credentialType: String, clientId: String,
                                    authTokenEndpoint: String, clientSecret: String) extends Serializable with CloudAccountCredentials
