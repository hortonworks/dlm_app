...
object CloudAccountEntities {
  ...
  implicit val gcsAccountCredentialFmt = Json.format[GCSAccountCredential]
  ...
  implicit val cloudAccountCredentialsFmt: Format[CloudAccountCredentials] = new Format[CloudAccountCredentials] {
    def reads(json: JsValue): JsResult[CloudAccountCredentials] = {
      def from(name: CloudCredentialType, data: JsObject): JsResult[CloudAccountCredentials] = name match {
        ...
        case WASB_ACCESSKEY  => Json.fromJson[WASBAccountCredential](data)(wasbAccountCredentialFmt)
        case WASB_SAS_TOKEN => Json.fromJson[WASBAccountCredentialSAS](data)(wasbAccountCredentialSasFmt)
        case GCS_PRIVATEKEY => Json.fromJson[GCSAccountCredential](data)(gcsAccountCredentialFmt)
        case ADLS_STS => Json.fromJson[ADLSAccountCredentials](data)(adlsAccountCredentialsFmt)
    ...
    def writes(cloudAccountCredentials: CloudAccountCredentials): JsValue = {
      cloudAccountCredentials match {
        ...
        case data: GCSAccountCredential => Json.toJson(data)(gcsAccountCredentialFmt)
  ...
  implicit val gcsAccountDetailsFmt = Json.format[GCSAccountDetails]
  ...
  implicit val cloudAccountDetailsFmt: Format[CloudAccountDetails] = new Format[CloudAccountDetails] {
    def reads(json: JsValue): JsResult[CloudAccountDetails] = {
      def from(name: CloudAccountProvider, data: JsObject): JsResult[CloudAccountDetails] = name match {
        ...
        case CloudAccountProvider.GCS => Json.fromJson[GCSAccountDetails](data)(gcsAccountDetailsFmt)
    ...
    def writes(cloudAccountDetails: CloudAccountDetails): JsValue = {
      cloudAccountDetails match {
        ...
        case data: GCSAccountDetails => Json.toJson(data)(gcsAccountDetailsFmt)
