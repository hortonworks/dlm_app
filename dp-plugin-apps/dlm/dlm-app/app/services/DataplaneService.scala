...
import com.hortonworks.dataplane.commons.domain.Entities.{Cluster, Error, Errors, ClusterService => ClusterData}
import com.hortonworks.dataplane.db.Webserice.{ClusterComponentService, ClusterService}
import models.{BeaconCluster, JsonResponses}
